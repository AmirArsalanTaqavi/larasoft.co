...
export default async function ServiceSinglePage({ params }: Props) {
  ...
  return (
    <main className='relative min-h-screen w-dvw px-6 pt-32 pb-20 md:px-12'>
      <article className='mx-auto max-w-6xl'>
        ...
        {/* Main Content */}
        <div
          className='font-vazirmatntext-foreground/90 prose prose-invert prose-lg prose-headings:font-larasoft prose-headings:font-light prose-a:text-accent hover:prose-a:text-accent/80 mb-16 max-w-none text-lg leading-loose'
        ...
        {slug === 'network-support' && (
          <section className=''>
            <div className='border-accent/20 bg-background/50 mx-auto w-full rounded-2xl border p-2 backdrop-blur-xl'>
              <PriceCalculator />
            </div>
          </section>
        )}
        ...
        {/* CTA Section */}
        <div className='border-accent/20 bg-accent/5 relative mt-24 rounded-3xl border p-8 text-center md:p-12'>
