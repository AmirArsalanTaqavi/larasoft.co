...
export default function NotFound() {
  return (
    <div className='text-foreground relative flex h-screen w-dvw flex-col items-center justify-center overflow-hidden'>
      ...
      <div className='bg-background/30 animate-in fade-in zoom-in relative z-10 space-y-6 rounded-3xl border border-white/5 p-8 text-center shadow-2xl backdrop-blur-2xl duration-500 md:p-12'>
        ...
        <h1 className='font-space text-4xl' dir='ltr'>
          404
        </h1>
        ...
        <p
          dir='ltr'
          className='font-space text-foreground/60 text-lg tracking-widest uppercase'
        >
          Page Not Found!
        </p>
